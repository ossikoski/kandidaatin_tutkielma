Tässä kappaleessa käsitellään uutta kaatosysteemiä, jonka avulla pyritään ratkaisemaan kappaleessa \ref{ch:vanhan_ongelmat} käsiteltyjä ongelmia. Kaatosysteemin käsittely sisältää sekä logiikan että robottikoodin ja näiden kahden rajapinnan.
...
%\begin{figure}[!h]
%\begin{center}
%\includegraphics[scale=0.4]{img/Sequence_shakebottle.png}   %0.6 scale
%\end{center}
%\caption{Sekvenssikaavio uudesta kaatosysteemistä}
%\label{fig:Sequence}
%\end{figure}

%\includepdf[pages=-]{sequence.pdf}

\begin{figure}[!h]
\begin{center}
\includegraphics[scale=0.8]{img/sequence.pdf}   %0.6 scale
\end{center}
\caption{Sekvenssikaavio uudesta kaatosysteemistä}
\label{fig:Sequence}
\end{figure}
